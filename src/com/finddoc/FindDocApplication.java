...
public final class FindDocApplication extends Application {
	...
	private static final String CLASS_NAME = FindDocApplication.class.getSimpleName();
	List<Doctor> itemList;

	public FindDocApplication() {
	...
	public void onCreate() {
		...
		// Register the Doctor Specialization.
		Doctor.registerSpecialization(Doctor.class);		
	}
	
	/**
	 * Returns the doctorList, an array of Doctor objects.
	 * @return doctorList
	 */
	public List<Doctor> getItemList() {
		return itemList;
	}
	
	public void setItemList(List<Doctor> list) {
		itemList = list;
	}
}